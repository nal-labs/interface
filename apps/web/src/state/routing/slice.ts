    ...
    getQuote: build.query<TradeResult, GetQuoteArgs>({
      queryFn(args, _api, _extraOptions, fetch) {
        return trace({ name: 'Quote', op: 'quote', data: { ...args } }, async (trace) => {
          ...
          //     console.log("apps/web/src/state/routing/slice.ts-args1", args)
          //     console.log("apps/web/src/state/routing/slice.ts-uraQuoteResponse1", uraQuoteResponse)
          ...
          // console.log("apps/web/src/state/routing/slice.ts-22222trytry")
          try {
            return trace.child({ name: 'Quote on client', op: 'quote.client' }, async () => {
              ...
              if (quoteResult.state === QuoteState.SUCCESS) {
                console.log("apps/web/src/state/routing/slice.ts-args2", args)
                console.log("apps/web/src/state/routing/slice.ts-quoteResult.data", quoteResult.data)
